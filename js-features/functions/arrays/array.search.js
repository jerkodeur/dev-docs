...
console.log(myTable.unshift('zéro'))

console.log(myTable)
console.log(myTable.slice(0, 4))
console.log(myTable.push('cinq'))
console.log(myTable)

const myNewTable = myTable.slice(0, 5)
console.log(myNewTable)
console.log(myNewTable.pop())
